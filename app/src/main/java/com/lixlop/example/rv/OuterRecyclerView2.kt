...
/**
 * @author fangkw on 2019-05-30
 **/
class OuterRecyclerView2(context: Context, attributeSet: AttributeSet) : RecyclerView(context, attributeSet) {
    ...
    private fun fetchNestedChild() : View? {
        ...
        if (view is FrameLayout) {
            ...
            if (linearLayout is YLinearLayout) {
